...
class SparkPower(nn.Module):
    ...
    def forward(self, x):
        ...
        p11_f1,p11_f2,p11_f3 = p11.chunk(3,3)
        p22_f1,p22_f2,p22_f3 = p22.chunk(3,2) 
        p33_f1,p33_f2,p33_f3, p33_f4,p33_f5 = p33.chunk(5,2)
        p44_f1 = p44
        ...
        p33_r5, p33_fc5 = self.p3_5(p33_f5)
        ...
        p33_at = torch.cat([p33_r1,p33_r2,p33_r3,p33_r4,p33_r5],dim=1)#256*2=512
        p44_at = p44_r1
        pg_at = torch.cat([pg_r1,pg_r2,pg_r3,pg_r4],dim=1)#256*4=1024

        predict = torch.cat([p11_at, p22_at, p33_at, p44_at, pg_at], dim=1)

        return (p11_at, p22_at, p33_at, p44_at, pg_at), (p22_fc1, p22_fc2, p22_fc3, p11_fc1, p11_fc2, p11_fc3, p33_fc1, p33_fc2, p33_fc3, p33_fc4, p33_fc5, p44_fc1, pg_fc1, pg_fc2, pg_fc3, pg_fc4), predict
